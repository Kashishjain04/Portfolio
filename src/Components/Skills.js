...
const Skills = () => (
  <div className="skills section" id="skills">
    ...
    <div className="skills__container bd-grid">
      <h2 className="skills__subtitle" data-aos="fade-down">Languages</h2>
      ...
      <h2 className="skills__subtitle" data-aos="fade-down">Technologies</h2>
      <div className="skills__list bd-grid">
        {skills.technologies.map((tech, index) => (
          <SkillCard
            ...
            data-aos="fade-down"
          data-aos-duration={400+(1000/skills.technologies.length)*index}
          />
        ))}
      </div>
    </div>
